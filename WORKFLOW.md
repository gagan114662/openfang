...
agent:
  ...
  max_concurrent_agents_by_state:
    In Review: 1
codex:
  command: mkdir -p "$PWD/.codex-home" && CODEX_HOME="$PWD/.codex-home" codex --config shell_environment_policy.inherit=all --config model_reasoning_effort=xhigh app-server
